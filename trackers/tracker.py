...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub = False, stub_path = None):  #read_from_stub is useful to run from scratch, stub_path is the output of it
        ...
        tracks = {
            "players" : [],  #for each frame, track id and we will get bounding boxes as a list of dictionaries
            "referees" : [],
            "ball" : []
        }
        ...
        for frame_num, detection in enumerate(detections):
            ...
            tracks["players"].append({})  #bounding boxes are appended
